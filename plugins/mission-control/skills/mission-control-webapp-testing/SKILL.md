...
2. Request a compact test plan.
3. Run approved browser or command checks through the configured runner.
4. Summarize observed behavior, errors, screenshots, and gaps.
