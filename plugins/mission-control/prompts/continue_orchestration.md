...
Resource sequence: `mission-control://orchestrations/{orchestration_id}/status` -> `mission-control://projects/{project_id}/agents` -> `mission-control://projects/{project_id}/pending-decisions`
