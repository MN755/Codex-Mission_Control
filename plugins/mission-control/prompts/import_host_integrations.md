...
Invocation name: `import_host_integrations`

## Purpose

Import Codex or Claude-discovered integration metadata into Mission Control before the operator starts guessing what is connected.
