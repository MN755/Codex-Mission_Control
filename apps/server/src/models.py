...
class Agent(Base):
    ...
    active_usage_json: Mapped[dict | None] = mapped_column(JSON, nullable=True)
...
class ProjectSettings(Base):
    ...
    remote_execution_policy_json: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)
    runner_mode: Mapped[str] = mapped_column(String(30), default="auto", nullable=False)
    ...
    launch_guard_enabled: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    hard_total_token_budget: Mapped[int] = mapped_column(Integer, default=2500000, nullable=False)
    hard_total_worker_launch_budget: Mapped[int] = mapped_column(Integer, default=120, nullable=False)
    hard_peak_context_budget: Mapped[int] = mapped_column(Integer, default=400000, nullable=False)
    quota_backoff_cooldown_minutes: Mapped[int] = mapped_column(Integer, default=60, nullable=False)
...
class SwarmBudget(Base):
    ...
    launch_guard_enabled: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    launch_guard_status: Mapped[str] = mapped_column(String(40), default="ok", nullable=False)
    launch_guard_reason: Mapped[str | None] = mapped_column(Text, nullable=True)
    hard_total_token_budget: Mapped[int] = mapped_column(Integer, default=2500000, nullable=False)
    observed_total_tokens: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    hard_total_worker_launch_budget: Mapped[int] = mapped_column(Integer, default=120, nullable=False)
    launches_started: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    hard_peak_context_budget: Mapped[int] = mapped_column(Integer, default=400000, nullable=False)
    observed_peak_context_tokens: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    quota_backoff_active: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utc_now, onupdate=utc_now)
...
class AppProfile(Base):
    ...
    adapter_command: Mapped[str | None] = mapped_column(Text, nullable=True)
    adapter_args_json: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False)
    remote_execution_registry_json: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)
