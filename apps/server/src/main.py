...
def preview_project_recovery_plans(
    ...
    return RecoveryPlanPreviewSummaryRead(
        ...
        persisted_statuses=preview["persisted_statuses"],
        persisted_status_counts=preview["persisted_status_counts"],
        persisted_status_group_count=preview["persisted_status_group_count"],
        persisted=[RecoveryPlanRead.model_validate(item) for item in preview["persisted"]],
        derived_trigger_types=preview["derived_trigger_types"],
        derived_trigger_type_counts=preview["derived_trigger_type_counts"],
        derived_trigger_type_group_count=preview["derived_trigger_type_group_count"],
        suggested_action_count=preview["suggested_action_count"],
        suggested_action_values=preview["suggested_action_values"],
        suggested_action_counts=preview["suggested_action_counts"],
        suggested_action_group_count=preview["suggested_action_group_count"],
        derived_candidates=preview["derived_candidates"],
        stored_count=preview["stored_count"],
        derived_candidate_count=preview["derived_candidate_count"],
        generated_at=preview["generated_at"],
