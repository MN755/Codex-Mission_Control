...
9. If Codex still does not show the plugin after reload, tell the user to rerun `python scripts/mission-control-manage.py update` and restart Codex again instead of pretending the skills-only fallback is equivalent.
