...
2. Attach the workspace or reuse the existing project that matches the user request.
3. Relay the user request through `mission_control_start_task`.
4. Poll status, event digest, and pending decisions instead of guessing.
