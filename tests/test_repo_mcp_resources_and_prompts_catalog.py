...
REQUIRED_PROMPT_ALIASES = [
    ...
    {"review-integration-catalog", "review_integration_catalog"},
    {"import-host-integrations", "import_host_integrations"},
    {"review-project-integrations", "review_project_integrations"},
    {"review-project-integration-family", "review_project_integration_family"},
    {"review-tensorflow-feature-catalog", "review_tensorflow_feature_catalog"},
    {"review-tensorflow-feature-bundle", "review_tensorflow_feature_bundle"},
    {"review-pytorch-feature-catalog", "review_pytorch_feature_catalog"},
    {"review-pytorch-feature-bundle", "review_pytorch_feature_bundle"},
    {"review-spatial-feature-catalog", "review_spatial_feature_catalog"},
    {"review-spatial-feature-bundle", "review_spatial_feature_bundle"},
